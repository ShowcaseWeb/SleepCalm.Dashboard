...
_TEXTS = {
    "title":              {"es": "Sleep Calm - Logistics Enterprise",             "es": "Sleep Calm - Logistics Enterprise"},
    "subtitle":           {"es": "Sistema Corporativo de Monitoramento de Entregas","es": "Sistema Corporativo de Monitoreo de Entregas"},
    "period":             {"es": "Periodo",         "es": "Periodo"},
    "meta_sla":           {"es": "Meta SLA",         "es": "Meta SLA"},
    "total_orders":       {"es": "TOTAL PEDIDOS",    "es": "TOTAL PEDIDOS"},
    "sla":                {"es": "SLA",              "es": "SLA"},
    "on_time":            {"es": "ENTREGAS NO PRAZO","es": "ENTREGAS A TIEMPO"},
    "delayed":            {"es": "ATRASADOS",        "es": "ATRASADOS"},
    "in_process":         {"es": "EM PROCESSO",      "es": "EN PROCESO"},
    "shipped":            {"es": "DESPACHADOS",      "es": "DESPACHADOS"},
    "not_delivered":      {"es": "NAO ENTREGUES",    "es": "NO ENTREGADOS"},
    "chart_sla_monthly":  {"es": "SLA por Mes - Comparativo Anual",              "es": "SLA por Mes - Comparativo Anual"},
    "chart_sla_trend":    {"es": "Tendencia do SLA",  "es": "Tendencia del SLA"},
    "chart_sla_carrier":  {"es": "SLA por Transportadora",                       "es": "SLA por Transportadora"},
    "chart_comparison":   {"es": "No Prazo vs Atrasado por Transportadora",      "es": "A Tiempo vs Atrasado por Transportadora"},
    "chart_sla_state":    {"es": "SLA por Estado (UF)",                          "es": "SLA por Estado (UF)"},
    "chart_top_skus":     {"es": "Top 10 SKUs Mais Vendidos",                    "es": "Top 10 SKUs Mas Vendidos"},
    "chart_status":       {"es": "Distribuicao de Status",                       "es": "Distribucion de Estados"},
    "chart_delay_dist":   {"es": "Distribuicao de Dias de Atraso",               "es": "Distribucion de Dias de Atraso"},
    "chart_aging":        {"es": "Aging de Pedidos Abertos",                     "es": "Aging de Pedidos Abiertos"},
    "chart_avg_time":     {"es": "Tempo Medio de Entrega por Transportadora",    "es": "Tiempo Promedio de Entrega por Transportadora"},
    "critical_orders":    {"es": "Pedidos Criticos (Nao Entregues)",             "es": "Pedidos Criticos (No Entregados)"},
    "no_pending":         {"es": "Nenhum pedido pendente de entrega!",           "es": "Ningun pedido pendiente de entrega!"},
    "filters":            {"es": "Filtros",           "es": "Filtros"},
    "year":               {"es": "Ano",               "es": "Ano"},
    "month":              {"es": "Mes",               "es": "Mes"},
    "all":                {"es": "Todos",             "es": "Todos"},
    "compare":            {"es": "Comparar com ano anterior",                    "es": "Comparar con ano anterior"},
    "carrier":            {"es": "Transportadora",    "es": "Transportadora"},
    "state":              {"es": "UF",                "es": "Estado"},
    "returns":            {"es": "Devolucao",         "es": "Devolucion"},
    "how_sla":            {"es": "Como o SLA e calculado?",                      "es": "Como se calcula el SLA?"},
    "sla_formula":        {"es": "SLA = (Entregues no Prazo / Total Entregues) x 100",
                                                                                 "es": "SLA = (Entregas a Tiempo / Total Entregas) x 100"},
    "sla_note":           {"es": "Apenas pedidos com status 'wc-completed' sao considerados",
                                                                                 "es": "Solo pedidos con estado 'wc-completed' son considerados"},
    "footer":             {"es": "Sleep Calm - Logistics Enterprise",            "es": "Sleep Calm - Logistics Enterprise"},
    "updated":            {"es": "Atualizado",        "es": "Actualizado"},
    "data_warnings":      {"es": "Alertas de Qualidade de Dados",                "es": "Alertas de Calidad de Datos"},
    "avg_delivery_days":  {"es": "Tempo Medio de Entrega",                       "es": "Tiempo Promedio de Entrega"},
    "days":               {"es": "dias",              "es": "dias"},
    "ranking_carrier":    {"es": "Ranking de Transportadoras",                   "es": "Ranking de Transportadoras"},
    "on_hold":            {"es": "ON-HOLD",           "es": "EN ESPERA"},
}
